...
Windows acceptance remains pending: the Hyper-V broker entered maintenance before application launch. The prepared native scenarios cover the packaged runtime and the editor's authoring, preview, and real export; browser results alone do not establish their acceptance.
